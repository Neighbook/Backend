...
export const environnement = {
	...
	api_description:
		...
		"Neighbook : Tutored project of FISA 3 - A22",
	...
	jwt_token_expiration_time:
		process.env.JWT_TOKEN_EXPIRATION_TIME || "2 days",
	jwt_token_issuer: process.env.JWT_TOKEN || "neighbook-api",
	...
	database: {
		...
		users_service_database: process.env.SERVICE_USER_DATABASE || "postgres",
	},
	logging: {
	...
	licence_url:
		process.env.LICENCE_URL || "https://spdx.org/licenses/MIT.html",
};
